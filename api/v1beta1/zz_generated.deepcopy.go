...
func (in *IngressNetworkingV1) DeepCopyInto(out *IngressNetworkingV1) {
	*out = *in
	...
	if in.Spec != nil {
		in, out := &in.Spec, &out.Spec
		*out = new(IngressNetworkingV1Spec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressNetworkingV1Spec) DeepCopyInto(out *IngressNetworkingV1Spec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressNetworkingV1Spec.
func (in *IngressNetworkingV1Spec) DeepCopy() *IngressNetworkingV1Spec {
	if in == nil {
		return nil
	}
	out := new(IngressNetworkingV1Spec)
