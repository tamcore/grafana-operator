...
type IngressNetworkingV1 struct {
	ObjectMeta ObjectMeta               `json:"metadata,omitempty"`
	Spec       *IngressNetworkingV1Spec `json:"spec,omitempty"`
}

// +kubebuilder:object:generate=true

type IngressNetworkingV1Spec struct {
	...
	// +optional
	DefaultBackend *v1.IngressBackend `json:"defaultBackend,omitempty" protobuf:"bytes,1,opt,name=defaultBackend"`
	...
	// +listType=atomic
	// +optional
	TLS []v1.IngressTLS `json:"tls,omitempty" protobuf:"bytes,2,rep,name=tls"`
	...
	// +patchMergeKey=host
	// +patchStrategy=merge
	Rules []v1.IngressRule `json:"rules,omitempty" protobuf:"bytes,3,rep,name=rules" patchStrategy:"merge" patchMergeKey:"host"`
}
